...
echo Running
java -cp ".:target/WatCA-1.0-SNAPSHOT.jar" ca.uwaterloo.watca.RegularityTest $INPUT_DIR $OUTPUT_DIR
...
echo "Explanation: "
echo "0 means OK"
echo "1 means regularity violation (bug!)"

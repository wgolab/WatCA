...
public class RegularityTest {
    ...
    public static void main(String[] args) throws IOException {       
        ...
        if (args.length < 2 || args.length > 3) {
            System.out.println("usage: java RegularityTest path_to_trace_files path_to_output_files <optional - showzeroscores>");
            return;
        }
        ...
        Analyzer a = new Analyzer(args[1], SCORE_FILE_NAME, showZeroScores, new RegularScoreFunction());
